...
public class AtomicIntegerTrack implements AtomicIntegerInterface {
    ...
    public static enum FUNCTION_KEY {
        ...
        GET((byte) 1, "get"),
        /**
         * Function id for @see java.util.concurrent.atomic.AtomicInteger#set(int newValue) .
         */
        SET((byte) 2, "set"),
        /**
         * Function id for @see java.util.concurrent.atomic.AtomicInteger#lazySet(int newValue) .
         */
        LAZYSET((byte) 3, "lazySet"),
        /**
         * Function id for @see java.util.concurrent.atomic.AtomicInteger#getAndSet(int newValue) .
         */
        GETANDSET((byte) 4, "getAndSet"),
        /**
         * Function id for @see java.util.concurrent.atomic.AtomicInteger#compareAndSet(int expect, int update) .
         */
