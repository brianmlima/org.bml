...
/**
 * A Utility for profiling of Long Objects.
 *
 * @author Brian M. Lima
 */
public class LongFieldProfiler implements AddUtil<Long> {
    ...
    private final Class fieldClass = Long.class;
    ...
    /**
     * Creates a new instance of LongFieldProfiler.
     *
     * @param fieldName The name of the field to be profiled.
     */
    public LongFieldProfiler(final String fieldName) {
        this.fieldName = fieldName;
    }

    @Override
    public void add(final Long dataObject) {
        sampleSize++;
        if (dataObject == null) {
            nullCount++;
            return;
