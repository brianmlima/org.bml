...
/**
 * A Utility for profiling of Double Objects.
 *
 * @author Brian M. Lima
 */
public class DoubleFieldProfiler implements AddUtil<Double> {
    ...
    private final Class fieldClass = Double.class;
    /**
    ...
    /**
     * Creates a new instance of DoubleFieldProfiler.
     *
     * @param fieldName The name of the field to be profiled.
     */
    public DoubleFieldProfiler(final String fieldName) {
        this.fieldName = fieldName;
    }

    @Override
    public void add(final Double dataObject) {
        sampleSize++;
        if (dataObject == null) {
            nullCount++;
            return;
